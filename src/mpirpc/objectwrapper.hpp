...
public:
    object_wrapper_base(void* object) : m_object(object), m_type(0) {
 ...
 */
template<typename T>
class ObjectWrapper : public object_wrapper_base
{
    friend class Manager;
public:
    ObjectWrapper(T* object = 0) :  object_wrapper_base(object) {}
